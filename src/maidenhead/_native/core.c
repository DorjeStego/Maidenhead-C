...
static double mh_clamp_lat(double lat) {
...
static double mh_wrap_lon_near(double lon, double ref) {
...
static int mh_lon_overlap(double a_min, double a_max, double b_min, double b_max) {
...
static int mh_point_in_poly(const mh_point *poly, size_t n, double lat, double lon) {
    int inside = 0;
    size_t j = n - 1;
...
static int mh_segments_intersect(mh_point a1, mh_point a2, mh_point b1, mh_point b2) {
